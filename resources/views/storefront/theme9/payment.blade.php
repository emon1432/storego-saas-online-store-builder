                                        ...
                                        <div class="card-body cart-subtotal">
                                            ...
                                            <div class="row mt-2 pt-2 p-2">
                                                ...
                                                <div class="col-5 text-right">
                                                    <span
                                                        class="text-sm font-weight-bold t-black15" id="sub_total">{{ \App\Models\Utility::priceFormat(!empty($sub_total) ? $sub_total : 0) }}</span>
                                                </div>
                                            </div>
                                            @foreach ($taxArr['tax'] as $k => $tax)
                                                <div class="row mt-2 pt-2 p-2 border-top">
                                                    ...
                                                    <div class="col-5 text-right">
                                                        ...
                                                        <span
                                                            class="text-sm font-weight-bold t-black15" id="">{{ \App\Models\Utility::priceFormat($taxArr['rate'][$k]) }}</span>
                                                    </div>
                                                </div>
                                            @endforeach
                                                ...
                                                <div class="shipping_price_add" >
                                                    <div class="row mt-2 pt-2 p-2 border-top">
                                                        ...
                                                        <div class="col-5 text-right"><span
                                                                ...
                                                                data-value="{{$shipping_price}}">{{ \App\Models\Utility::priceFormat($shipping_price) }}</span></div>
                                                    </div>
                                                </div>
                                            @endif
                                            ...
                                            <div class="row mt-2 pt-2 border-top">
                                                ...
                                                <div class="col-5 text-right final_total_price">
                                                    <span class="text-sm font-weight-bold s-p-total pro_total_price"
                                                        data-original="{{ \App\Models\Utility::priceFormat(!empty($final_total) ? $final_total : 0) }}">
                                                        {{ \App\Models\Utility::priceFormat(!empty($final_total) ? $final_total : '0') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
