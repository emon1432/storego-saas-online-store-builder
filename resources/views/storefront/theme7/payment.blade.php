                ...
                <div class="tab-pane tab-active" data-id="tab3">
                                            ...
                                            <div class="col-12 col-lg col-md-4 text-right">
                                                ...
                                                <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                                    ...
                                                    <div class="form-group">
                                                        <button type="button" class="btn btn-secondary btn-sm payment-btn payment-btn"
                                ...
                                <div class="box-space">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 text-right pr-0">
                                        <div class="form-group">
                                            ...
                                            <button class="btn btn-secondary btn-sm pt-0 payment-btn" type="submit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-md-4 col-sm-12 text-right">
                                        ...
                                        <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                            ...
                                            <input type="hidden" name="product_id">
                                            <div class="form-group mt-3">
                                                <button type="button" class="btn btn-secondary btn-sm payment-btn"
                                    ...
                                    <div class="col-12 col-lg-4 col-md-4 text-right">
                                        ...
                                        <div class="form-group mt-3">
                                            <div class="text-sm-right ">
                                                <button class="btn btn-secondary btn-sm float-right payment-btn" type="button"
                                    ...
                                    <div class="col-12 col-lg-4 col-md-4 text-right">
                                        ...
                                        <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                            ...
                                            <div class="form-group mt-3">
                                                <div class="text-sm-right ">
                                                    <button type="submit"
                                                        class="btn btn-secondary btn-sm float-right payment-btn">{{ __('Pay Now') }}</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 col-md-4 text-right">
                                        ...
                                        <div class="form-group mt-3">
                                            <div class="text-sm-right ">
                                                <button type="button" class="btn btn-secondary btn-sm float-right payment-btn"
                    ...
                    @endif
                                ...
                                <div class="mt-2 mt-sm-4 text-center text-sm-right">
                                    <a href="{{ route('store.slug', $store->slug) }}" class="text-secondary">
                                        {{__('Return to shop')}}
                                    </a>
                                    <a href="#" class="btn btn-secondary ml-4 px-5 rounded-pill">
